...
function getClientEnv(env: ElectronicPrescriptionClientEnv | undefined): ElectronicPrescriptionClientEnv {
  ...
  return {
    ELECTRONIC_PRESCRIPTION_MODE: appEnv.electronicPrescriptionMode,
    ELECTRONIC_PRESCRIPTION_ENDPOINT: appEnv.electronicPrescriptionEndpoint,
    ELECTRONIC_PRESCRIPTION_BEARER_TOKEN: appEnv.electronicPrescriptionBearerToken,
    ELECTRONIC_PRESCRIPTION_TIMEOUT_MS: String(appEnv.electronicPrescriptionTimeoutMs),
    ELECTRONIC_PRESCRIPTION_CONNECTOR_KIND: appEnv.electronicPrescriptionConnectorKind,
    ELECTRONIC_PRESCRIPTION_CONNECTOR_ARTIFACT_SHA256: appEnv.electronicPrescriptionConnectorArtifactSha256,
    ELECTRONIC_PRESCRIPTION_CAPABILITIES: appEnv.electronicPrescriptionCapabilities,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_OUTCOME: appEnv.electronicPrescriptionLastAttemptOutcome,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_AT: appEnv.electronicPrescriptionLastAttemptAt,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_STATUS_CODE: appEnv.electronicPrescriptionLastAttemptStatusCode ? String(appEnv.electronicPrescriptionLastAttemptStatusCode) : undefined,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_RESPONSE_SHAPE: appEnv.electronicPrescriptionLastAttemptResponseShape,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_CONNECTOR_KIND: appEnv.electronicPrescriptionLastAttemptConnectorKind,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_CONNECTOR_ARTIFACT_SHA256: appEnv.electronicPrescriptionLastAttemptConnectorArtifactSha256,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_CAPABILITIES: appEnv.electronicPrescriptionLastAttemptCapabilities,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_ENDPOINT_SHA256: appEnv.electronicPrescriptionLastAttemptEndpointSha256,
    ELECTRONIC_PRESCRIPTION_LAST_ATTEMPT_AUTH_SHA256: appEnv.electronicPrescriptionLastAttemptAuthSha256
  };
}
